...
> **Quick Navigation:** This folder contains supporting documentation for the hackathon submission. The main project README is at [(https://github.com/pt-act/OpenMetadata/blob/main/README.md).
